...
public class ApplicationContextManager {
    ...
    public synchronized static void init(String projectId) throws Exception {
        if (applicationContextManager != null) {
            throw new RuntimeException();
        }
        applicationContextManager = new ApplicationContextManager(new ApplicationContext(projectId));
    }
